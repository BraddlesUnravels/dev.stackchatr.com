    ...
    <PageBaseContainer class="flex flex-col gap-6 text-white">
      <section class="space-y-2">
        ...
        <p class="max-w-2xl text-lg text-slate-200">
          A playground of small, focused puzzles where you can sort, search, and
          path-find your way through classic algorithms. The goal is to make
          algorithms, data structures, and performance feel visual and
          intuitive.
        </p>
      </section>
      ...
      <section class="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <p class="mt-2 text-sm text-slate-200">
            Drag and shuffle bars, then watch how different sorting algorithms
            (like bubble sort, insertion sort, and quicksort) reorganize them
            step by step.
          </p>
        ...
        <Card>
          ...
          <p class="mt-2 text-sm text-slate-200">
            Experiment with linear vs. binary search on the same data set and
            see how many steps it takes to find the target.
          </p>
          <p class="mt-3 text-xs tracking-wide text-slate-400 uppercase">
        ...
        <Card>
          <Link href="/algorithm-adventures/dijkstra">
            <h2 class="text-xl font-semibold">Path-finding Playground</h2>
            <p class="mt-2 text-sm text-slate-200">
              Drag start and end nodes, drop walls, and watch algorithms like
              Dijkstra and A* explore the grid in real time.
            </p>
            <p class="mt-3 text-xs tracking-wide text-slate-400 uppercase">
      ...
      <section class="max-w-2xl space-y-3 text-sm text-slate-200">
        ...
        <p>
          This page is dedicated to building interactive, visual explanations of
          algorithms and data structures. Each puzzle will be small and focused,
          so you can explore one idea at a time without getting lost in
          boilerplate.
        </p>
        ...
        <ul class="list-disc space-y-1 pl-6">
          ...
          <li>
            Step-by-step playback controls to pause, rewind, and scrub through
            executions.
          </li>
          <li>
            Inline explanations of time and space complexity tied to what you
            see on screen.
          </li>
        </ul>
      </section>
